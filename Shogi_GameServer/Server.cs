...
namespace Shogi_GameServer
{
    class Server
    {
        ...
        public static void InitializeBoard()
        {
            ...
            Console.WriteLine($"-------------------------------------");
            Console.WriteLine($"|     INITIALIZING BOARD STATE      |");
            Console.WriteLine($"-------------------------------------");
            ...
            for (int x = 0; x < 9; x++)
            {
                ...
                Console.WriteLine($"-- Initializing Player [1] Fuhyo piece added on key value {key}");
                pieces.Add(key++, Fuhyo_A);                

                Piece Fuhyo_B = new Piece(key, playerTwo, "Fuhyo", x, 6);
                Console.WriteLine($"-- Initializing Player [2] Fuhyo piece added on key value {key}");
            ...
            for (int x = 3; x <= 5; x += 2)
            {
                ...
                Console.WriteLine($"-- Initializing Player [1] Kinsho piece added on key value {key}");
                pieces.Add(key++, Kinsho_A);                

                Piece Kinsho_B = new Piece(key, playerTwo, "Kinsho", x, 8);
                Console.WriteLine($"-- Initializing Player [2] Kinsho piece added on key value {key}");
            ...
            for (int x = 2; x <= 6; x += 4)
            {
                ...
                Console.WriteLine($"-- Initializing Player [1] Ginsho piece added on key value {key}");
                pieces.Add(key++, Ginsho_A);                

                Piece Ginsho_B = new Piece(key, playerTwo, "Ginsho", x, 8);
                Console.WriteLine($"-- Initializing Player [2] Ginsho piece added on key value {key}");
            ...
            for (int x = 1; x <= 7; x += 6)
            {
                ...
                Console.WriteLine($"-- Initializing Player [1] Keima piece added on key value {key}");
                pieces.Add(key++, Keima_A);                

                Piece Keima_B = new Piece(key, playerTwo, "Keima", x, 8);
                Console.WriteLine($"-- Initializing Player [2] Keima piece added on key value {key}");
            ...
            for (int x = 0; x <= 8; x += 8)
            {
                ...
                Console.WriteLine($"-- Initializing Player [1] Kyosha piece added on key value {key}");
                pieces.Add(key++, Kyosha_A);                

                Piece Kyosha_B = new Piece(key, playerTwo, "Kyosha", x, 8);
                Console.WriteLine($"-- Initializing Player [2] Kyosha piece added on key value {key}");
                pieces.Add(key++, Kyosha_B);                
            }

            // Kakugyo
            Piece Kakugyo_A = new Piece(key, playerOne, "Kakugyo", 1, 1);
            Console.WriteLine($"-- Initializing Player [1] Kakugyo piece added on key value {key}");
            pieces.Add(key++, Kakugyo_A);

            Piece Kakugyo_B = new Piece(key, playerTwo, "Kakugyo", 7, 7);
            Console.WriteLine($"-- Initializing Player [2] Kakugyo piece added on key value {key}");
            pieces.Add(key++, Kakugyo_B);

            // Hisha
            Piece Hisha_A = new Piece(key, playerOne, "Hisha", 7, 1);
            Console.WriteLine($"-- Initializing Player [1] Hisha piece added on key value {key}");
            pieces.Add(key++, Hisha_A);

            Piece Hisha_B = new Piece(key, playerTwo, "Hisha", 1, 7);
            Console.WriteLine($"-- Initializing Player [2] Hisha piece added on key value {key}");
